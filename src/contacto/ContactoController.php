...
{
    private const ADMIN_EMAIL = 'motka2269@gmail.com';
    ...
    public function enviar(Request $request, Response $response, array $params): void
    {
        ...
        try {
            if ($this->smtpConfigurado()) {
                ...
                $mailer->send(self::ADMIN_EMAIL, $asuntoAdmin, $cuerpoAdmin);
                $mailer->send($email, $asuntoUsuario, $cuerpoUsuario);
            } else {
                $this->registrarLog(self::ADMIN_EMAIL, $asuntoAdmin, $cuerpoAdmin);
